...
namespace SGInstall
{
	public static class FontHelper
	{
		...
		public static Font GetFirstAvailableFont (string [] fontNames, float? defaultFontSize = null, FontStyle ?dfltFontStyle = null)
		{
			...
			foreach (string fontName in fontNames)
			{
				foreach (FontFamily family in families)
				{
					...
					{
						return new Font (family, targetSize, dfltFontStyle ?? FontStyle.Regular);
					}
				}
			}
